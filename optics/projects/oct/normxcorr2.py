...
def normxcorr2(template, image, mode='full'):
    ...
    Details:
    Normalized cross-correlation. Similar results up to 3 significant digits.
    https://github.com/Sabrewarrior/normxcorr2-python/master/norxcorr2.py
    http://lordsabre.blogspot.ca/2017/09/matlab-normxcorr2-implemented-in-python.html

    Input arrays should be floating point dtype.
    ...
    image = fftconvolve(image ** 2, a1, mode=mode) - (fftconvolve(image, a1, mode=mode) ** 2) / template.size
