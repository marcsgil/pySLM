...
if __name__ == '__main__':
    ...
    for _, img in enumerate(slices_rgba):
        ...
        Image.fromarray((img * 255.5).astype(np.uint8), mode='RGBA').save(image_output_path)

    log.info('Displaying...')
    fig, axs = plt.subplots(2, fld.ndim)
    for _ in range(fld.ndim):
