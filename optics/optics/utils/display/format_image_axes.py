...
def format_image_axes(axes, title: str = None, scale: float = 0, unit: str = '', white_background: bool = False):
    """
    ...
    if scale > 0:  # Add scale bar
        ...
        scale_bar = AnchoredSizeBar(axes.transData,
                                    scale_bar_size, f'{ureg.Quantity(scale_bar_size, unit):#P~0.0f}', 'lower right',
