...
class DM(object):
    ...
    def __init__(self, serialNumber):
        ...
        _asdk39.DM_swiginit(self, _asdk39.new_DM(serialNumber))
    __swig_destroy__ = _asdk39.delete_DM

    def Reset(self):
        r"""Reset(DM self) -> acs::COMPL_STAT"""
        return _asdk39.DM_Reset(self)

    def Stop(self):
        r"""Stop(DM self) -> acs::COMPL_STAT"""
        return _asdk39.DM_Stop(self)
    ...
    def Send(self, *args):
        ...
        """
        return _asdk39.DM_Send(self, *args)
    ...
    def SendOne(self, arg2, arg3, arg4, arg5):
        ...
        return _asdk39.DM_SendOne(self, arg2, arg3, arg4, arg5)
    ...
    def Set(self, *args):
        ...
        """
        return _asdk39.DM_Set(self, *args)

    @staticmethod
    def Check():
        r"""Check() -> acs::Bool"""
        return _asdk39.DM_Check()

    @staticmethod
    def GetLastError():
        r"""GetLastError() -> acs::UInt"""
        return _asdk39.DM_GetLastError()

    def __str__(self):
        r"""__str__(DM self) -> char *"""
        return _asdk39.DM___str__(self)

# Register DM in _asdk39:
_asdk39.DM_swigregister(DM)
...
def __lshift__(arg1, arg2):
    ...
    return _asdk39.__lshift__(arg1, arg2)
